...
// Return a pointer-to-refinable-tag if the given bus_dma_tag_t is an IOCap-able tag - i.e. whether you can call bus_dma_tag_refine_to_iocap_group on it.
...
// Return pointer-to-iocap-dmamap if the given bus_dmamap_t is an IOCap-able map - i.e. whether you can call bus_dmamap_mint_iocap
